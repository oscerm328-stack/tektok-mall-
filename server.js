...
<div style="background:white;padding:18px 15px 22px;margin:10px 0;">
  ...
  <!-- البانر الرئيسي: شعار + اسم + صورة توضيحية + نصان - كلها في صف أفقي واحد -->
  <div style="display:flex;align-items:center;gap:12px;">
    <!-- أيقونة TikTok سوداء كبيرة على اليسار -->
    <div style="flex-shrink:0;width:100px;height:100px;background:#000;border-radius:22px;box-shadow:0 4px 16px rgba(0,0,0,0.25);display:flex;align-items:center;justify-content:center;">
    ...
    <!-- اسم TikTok Mall + صورة توضيحية + النصان -->
    <div style="flex:1;display:flex;flex-direction:column;gap:6px;">
      <!-- اسم TikTok Mall كبير -->
      <div style="font-size:32px;font-weight:900;color:#1a7fd4;letter-spacing:-0.5px;line-height:1;font-family:Arial Black,Arial,sans-serif;">TikTok Mall</div>
      <!-- الصورة التوضيحية + النصان في صف -->
